...
namespace collegeCompanionApp.Controllers
{
    public class PartiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PartyID,PartyName,PartyEmail")] Party party)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PartyID,PartyName,PartyEmail")] Party party)
        {
            if (ModelState.IsValid)
            {
